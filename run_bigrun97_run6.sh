...
export RUN_NAME="${RUN_NAME:-bigrun97_dec28_run6_evos0_imagenet_dlrmul_0_4}"
tmux-set-title "$${TPU_NAME} ${RUN_NAME}"
export MODEL_DIR="${MODEL_DIR:-gs://mlpublic-euw4/runs/bigrun97/dec28/run6_evos0_imagenet_dlrmul_0_4}"
...
while true; do
  timeout --signal=SIGKILL 16h \
    ...
    --gin_bindings "ModularGAN.d_lr_mul = 0.4" \
    \
