...
export RUN_NAME="${RUN_NAME:-bigrun94_big512}"
tmux-set-title "${RUN_NAME} ${TPU_NAME}"
export MODEL_DIR="${MODEL_DIR:-gs://doto-euw4a/runs/bigrun94_big512/}"
export GIN_CONFIG="example_configs/bigrun94_big512.gin"
