...
export RUN_NAME="${RUN_NAME:-bigrun97_dec28_run5_evos0_danbooru_dlrmul_0_2}"
tmux-set-title "$${TPU_NAME} ${RUN_NAME}"
export MODEL_DIR="${MODEL_DIR:-gs://mlpublic-euw4/runs/bigrun97/dec28/run5_evos0_danbooru_dlrmul_0_2}"
