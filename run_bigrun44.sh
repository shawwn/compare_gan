...
printf '\033]2;%s\033\\' "bigrun44 ${TPU_NAME}" # set tmux title
export MODEL_DIR="${MODEL_DIR:-gs://darnbooru-euw4a/runs/bigrun44/}"
export GIN_CONFIG="${GIN_CONFIG:-example_configs/bigrun44.gin}"
export LOGDIR="${LOGDIR:-logs44.txt}"
