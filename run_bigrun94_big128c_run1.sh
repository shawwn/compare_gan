...
export RUN_NAME="${RUN_NAME:-bigrun94_big128c}"
tmux-set-title "${RUN_NAME} ${TPU_NAME}"
export MODEL_DIR="${MODEL_DIR:-gs://doto-euw4a/runs/bigrun94_big128/v3_8/c/run1}"
export GIN_CONFIG="example_configs/bigrun94_big128c.gin"
