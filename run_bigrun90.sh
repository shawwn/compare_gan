...
export TPU_NAME="${TPU_NAME:-tpu-v3-256-euw4a-0}"

export RUN_NAME="bigrun90"
tmux-set-title "${RUN_NAME} ${TPU_NAME}"
export MODEL_DIR="${MODEL_DIR:-gs://dota-euw4a/runs/bigrun90/}"
export GIN_CONFIG="example_configs/bigrun90.gin"
