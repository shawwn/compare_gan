...
export TPU_NAME="${TPU_NAME:-tpu-v3-8-euw4a-4}"

export RUN_NAME="${RUN_NAME:-bigrun95_big512_evos0}"
tmux-set-title "${RUN_NAME} ${TPU_NAME}"
export MODEL_DIR="${MODEL_DIR:-gs://doto-euw4a/runs/bigrun95_big512_evos0/run0}"
export GIN_CONFIG="example_configs/bigrun95_big512_evos0.gin"
