...
def get_options_dict(batch_size=gin.REQUIRED,
  ...
  return {
      ...
      "d_flood": d_flood,
      "g_flood": g_flood,
      "d_stop_d_below": d_stop_d_below,
      "d_stop_g_above": d_stop_g_above,
      "g_stop_g_below": g_stop_g_below,
      "g_stop_d_above": g_stop_d_above,
      "g_fake_sim": g_fake_sim,
      "d_fake_sim": d_fake_sim,
